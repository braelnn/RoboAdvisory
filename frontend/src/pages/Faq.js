...
const FAQ = () => {
  ...
  const faqData = [
    ...
    { question: "Can I export my data?", answer: "Yes, you can export your data from the 'Settings' page." },
    { question: "Can I share my account with others?", answer: "No, sharing accounts is against our terms of service." },
    { question: "Can I customize my dashboard?", answer: "Yes, you can personalize your dashboard settings in the 'Preferences' tab." },
